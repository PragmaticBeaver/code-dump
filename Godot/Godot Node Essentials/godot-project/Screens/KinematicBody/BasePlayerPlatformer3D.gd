...
func apply_base_movement(delta: float) -> void:
	...
	# ANCHOR: set_model_velocity
	_model.velocity = _velocity
	# END: set_model_velocity

# ANCHOR: camera_oriented_input
func _get_camera_oriented_input() -> Vector3:
	...
	return input
# END: camera_oriented_input

# ANCHOR: orient_character_to_direction
...
# END: orient_character_to_direction
