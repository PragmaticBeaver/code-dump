...
# END: _on_Timer_timout
	_plop.emitting = true

# ANCHOR: _animate_laser_swipe
...
# END: _animate_laser_swipe
	_plop.translation = position

# ANCHOR: _randv_hemisphere
