...
# ANCHOR: offset_constant
const OFFSET := 0.001
# END: offset_constant
# ANCHOR: tile_constants
...
# END: neighbors_constant
# ANCHOR: autotile_constants
